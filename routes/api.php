...
Route::prefix('{server}')->group(function() {
    ...
    Route::get('/product/{resource}/{country}/{quality}', function ($server, $resource, $country, $quality) {
        if ($country == 0) {
            $country = -1;
        }
    ...
    Route::get('/citizen/{id}', function ($server, $id) {
    ...
    Route::get('/exchange/{from}/{to}', function ($server, $from, $to) {
